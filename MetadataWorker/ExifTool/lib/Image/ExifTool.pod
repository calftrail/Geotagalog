...
in your home directory, but a different file may be specified by setting the
ExifTool C<configFile> variable before using Image::ExifTool.  For example:
...
NikonScan, Olympus, PDF, PICT, PNG, Panasonic, Pentax, PSP, PhotoMechanic,
